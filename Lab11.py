...
def help():
  print "Here are a list of commands that you may find useful"
...
def main():
  ...
  while True:
    pick = requestString("Would you like to enter the North Room? (Y/N)")
    if pick.lower() == 'y':
      print "You have entered the North Room"
      break
    elif pick.lower() == 'n':
      print "You stand in place wondering where you should go."
    else:
      print "I am not familiar with that choice"
      
  while True:
    print m.__getitem__(0, 1).name
    print m.__getitem__(0, 1).description
    break
